...
- Verification:
  - pending after patch.
- Coverage gaps / risk:
  - parent portal dashboard fixtures are now normalized; remaining attendance row coverage lives in record-level tests rather than dashboard payload fixtures.
