      ...
      if (pathname === "/api/parent/dashboard" && method === "GET") {
        return jsonTextResponse(200, {
          children: [
            {
              eaglesId: "vi001",
              attendance: { total: 20, present: 19, absent: 1, late: 0, tardy10: 0, tardy30: 0, excused: 0 },
          ...
          children: [
            {
              ...
              fullName: "Student One",
              currentGrade: "A2 Flyers",
              attendance: { total: 20, present: 19, absent: 1, late: 1, tardy10: 1, tardy30: 0, excused: 0 },
...
test("parent portal attendance overview renders class/tardy square stats", async () => {
      ...
      if (pathname === "/api/parent/dashboard" && method === "GET") {
        return jsonTextResponse(200, {
          ...
          children: [
            {
              eaglesId: "vi001",
              attendance: { total: 40, present: 38, absent: 2, late: 4, tardy10: 3, tardy30: 1, excused: 0 },
              assignments: { pending: 0, overdue: 0 },
  ...
  assert.equal(normalizeText(document.getElementById("attendanceClassesAttendedValue")?.textContent), "38")
  assert.equal(normalizeText(document.getElementById("attendanceClassesTotalValue")?.textContent), "40")
  assert.equal(normalizeText(document.getElementById("attendanceRateValue")?.textContent), "95%")
      ...
      if (pathname === "/api/parent/dashboard" && method === "GET") {
        return jsonTextResponse(200, {
          ...
          children: [
            {
              eaglesId: "vi001",
              attendance: { total: 10, present: 10, absent: 0, late: 0, tardy10: 0, tardy30: 0, excused: 0 },
              assignments: { pending: 0, overdue: 0 },
              grades: { averageScorePercent: 92 },
              performance: { reportCount: 2 },
              details: {
      ...
      if (pathname === "/api/parent/dashboard" && method === "GET") {
        return jsonTextResponse(200, {
          children: [
            {
              eaglesId: "vi001",
              attendance: { total: 0, present: 0, absent: 0, late: 0, tardy10: 0, tardy30: 0, excused: 0 },
              assignments: { pending: 0, overdue: 0 },
