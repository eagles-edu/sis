...
test("portal hub panels stay on the secondary color without translucent panel backgrounds", () => {
  assert.match(hubHtml, /--hub-panel-bg:\s*var\(--secondary-color\);/)
  assert.match(hubHtml, /--hub-panel-bg-footer:\s*var\(--secondary-color\);/)
  assert.match(hubHtml, /--hub-panel-bg-hero:\s*var\(--secondary-color\);/)
  assert.match(hubHtml, /--hub-panel-bg-section:\s*var\(--secondary-color\);/)
  assert.match(hubHtml, /--hub-panel-bg-support:\s*var\(--secondary-color\);/)
  ...
  assert.match(hubHtml, /body\.portal-hub-page \.hub-prefooter \{\s*align-items: center;\s*background: var\(--secondary-color\);/s)
  ...
  assert.match(hubHtml, /body\.portal-hub-page \.portal-card--admin,\s*body\.portal-hub-page \.portal-card--parent,\s*body\.portal-hub-page \.portal-card--student \{\s*background: var\(--secondary-color\);/s)
  assert.match(hubHtml, /panelBg:\s*"var\(--secondary-color\)"/)
})
