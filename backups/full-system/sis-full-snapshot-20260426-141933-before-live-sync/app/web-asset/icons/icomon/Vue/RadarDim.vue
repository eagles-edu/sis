<template>
    <svg viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" fill="none" width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <defs stroke-width="1.25" stroke="currentColor">
        ...
        <path stroke-linecap="butt" stroke-linejoin="miter" fill="url(#radar_dim_gradient0)" d="M12 0a1 1 0.7854 0 1 0.7071 0.2929C13 0.5858 13 0.9497 13 1.3137V12h-2V1.3137c0-0.364 0-0.7279 0.2929-1.0208A1 1 0.7854 0 1 12 0z">
