...
test("student and parent portals use the shared semantic button contract", () => {
  ...
  assert.match(studentHtml, /id="closeNewsWeekSetModalBtn" class="portal-modal-close portal-button portal-button-warning"/)
  assert.match(studentHtml, /id="newsWeekSetModalCloseActionBtn" type="button" class="portal-button portal-button-warning"/)
  assert.match(studentHtml, /class="header-action-btn portal-button portal-button-alt plus"/)
  ...
  assert.match(parentHtml, /id="saveDraftBtn" type="button" class="portal-button portal-button-alt"/)
  ...
  assert.match(parentHtml, /id="closePastDueHomeworkModalBtn" class="portal-modal-close portal-button portal-button-warning"/)
  assert.match(parentHtml, /id="closeNewsWeekSetModalBtn" class="portal-modal-close portal-button portal-button-warning"/)
  assert.match(parentHtml, /id="newsWeekSetModalCloseActionBtn" type="button" class="portal-button portal-button-warning"/)
  assert.match(parentHtml, /id="closePerformanceReportModalBtn" class="portal-modal-close portal-button portal-button-warning"/)
  assert.match(parentHtml, /id="closeReportAccessErrorModalBtn" class="portal-modal-close portal-button portal-button-warning"/)
  assert.match(parentHtml, /id="logoutBtn" type="button" class="portal-button portal-button-danger"/)
  assert.match(parentHtml, /class="header-action-btn portal-button portal-button-alt plus"/)
