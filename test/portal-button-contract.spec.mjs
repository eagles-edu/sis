...
test("student and parent portals use the shared semantic button contract", () => {
  ...
  assertButtonContract(parentHtml, { id: "parentThemeToggle", className: "portal-theme-toggle portal-button portal-button-immutable-chrome" })
  assertButtonContract(parentHtml, { id: "parentTextZoomResetBtn", className: "portal-button portal-button-warning", type: "button" })
...
test("admin portal sources use the shared semantic button contract", () => {
  ...
  assertButtonContract(adminHtml, { id: "adminThemeToggle", className: "portal-theme-toggle portal-button portal-button-immutable-chrome" })
  assertButtonContract(adminHtml, { id: "globalTextZoomResetBtn", className: "portal-button portal-button-warning", type: "button" })
