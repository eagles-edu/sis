...
test("student New Words page exposes editable, sortable, paginated vocabulary", () => {
  ...
  assert.match(SHARED_THEME, /new-word-entry-head > strong\.new-word-entry-part-of-speech \{\s*color: #212121;\s*font-size: 1rem;\s*font-weight: 800;/)
  assert.match(SHARED_THEME, /html\[data-theme="dark"\][\s\S]*new-word-entry-head > strong\.new-word-entry-part-of-speech \{\s*color: #fbffff;\s*font-size: 1rem;\s*font-weight: 800;/)
