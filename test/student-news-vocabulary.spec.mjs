...
test("student Library replaces the standalone New Words page with My Words filtering", () => {
  ...
  assert.match(SHARED_THEME, /html:not\(\[data-theme="dark"\]\) :where\(body\.student-portal-page, body\.admin-portal-page, body\.parent-portal-page\) \.new-word-entry-head > strong\.new-word-entry-part-of-speech \{\s*color: #212121!important;\s*font-size: calc\(1\.28rem \+ 2px\)!important;\s*font-weight: 800!important;/)
  assert.match(SHARED_THEME, /html\[data-theme="dark"\] :where\(body\.student-portal-page, body\.admin-portal-page, body\.parent-portal-page\) \.new-word-entry-head > strong\.new-word-entry-part-of-speech \{\s*color: #fbffff!important;\s*font-size: calc\(1\.28rem \+ 2px\)!important;\s*font-weight: 800!important;/)
  ...
  assert.match(SHARED_THEME, /html\[data-theme="dark"\] body\.student-portal-page \.new-word-entry-head strong,[\s\S]*color: #F4C45F/)
  assert.match(SHARED_THEME, /html:not\(\[data-theme="dark"\]\) :where\(body\.student-portal-page, body\.admin-portal-page, body\.parent-portal-page\) \.new-word-entry-head strong \{[\s\S]*color: #000000/)
