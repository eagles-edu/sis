...
const PARENT_PORTAL_HTML_FOR_TEST = PARENT_PORTAL_HTML
  ...
  .replace(/<link rel="stylesheet" href="\/web-asset\/shared\/portal-theme-colors\.min\.css">\s*/i, "")
  .replace(/<link rel="stylesheet" href="\/web-asset\/shared\/student-parent-structure\.min\.css">\s*/i, "")
  .replace(/<style id="student-parent-critical-css">[\s\S]*?<\/style>\s*/i, "")
  .replace(/<script src="\/web-asset\/shared\/portal-theme-state\.js"><\/script>\s*/i, "")
  .replace(/<script src="\/web-asset\/shared\/portal-navigation\.js"><\/script>\s*/i, "")
  .replace(/<script src="\/web-asset\/shared\/portal-action-feedback\.js"><\/script>\s*/i, "")
  .replace(/<script src="\/web-asset\/shared\/portal-preferences\.js"><\/script>\s*/i, "")
  .replace(/<script src="\/web-asset\/shared\/portal-password-visibility\.js"><\/script>\s*/i, "")
