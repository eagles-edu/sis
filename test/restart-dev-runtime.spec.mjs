...
test("restart-dev-runtime rebuilds assets and refreshes Prisma before relaunching", () => {
  ...
  assert.match(script, /main\(\) \{\s+build_admin_assets\s+stop_runtime\s+refresh_runtime_prisma_client\s+start_runtime/s)
})
