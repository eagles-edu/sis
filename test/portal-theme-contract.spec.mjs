...
test("shared portal theme keeps the overview grids at 3x3, not wider", () => {
  assert.match(sharedTheme, /body\.parent-portal-page \.metrics,body\.student-portal-page \.metrics\{grid-template-columns:repeat\(3,minmax\(0,1fr\)\)/)
  assert.doesNotMatch(
    sharedTheme,
...
test("shared portal theme keeps unauthenticated header bars aligned to the login panel width", () => {
  assert.ok(
    sharedTheme.includes(".portal-login-header") &&
      sharedTheme.includes(".portal-login-footer") &&
