...
export function initAssignmentEngagementIsland({ document, state, api, helpers, onError }) {
  ...
  const metric = (row = {}) => {
    ...
    return {
      ...
      emailProxy: brevo.proxyLoadedAt || row.proxyLoadedAt ? "yes" : "",
      emailFirst: brevo.firstOpenedAt || row.firstOpenedAt ? "yes" : "",
      emailUnique: brevo.uniqueOpenedAt || row.uniqueOpenedAt ? "yes" : "",
      ...
      emailProxyAt: brevo.proxyLoadedAt || row.proxyLoadedAt || "",
      emailFirstAt: brevo.firstOpenedAt || row.firstOpenedAt || "",
      emailUniqueAt: brevo.uniqueOpenedAt || row.uniqueOpenedAt || "",
