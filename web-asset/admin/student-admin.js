        ...
        filteredTemplates.forEach((template) => {
          ...
          <td class="table-row-options-cell">
            <details class="row-options-menu">
              <summary class="row-options-trigger portal-button portal-button-blue-action portal-button-compact">Actions</summary>
              <div class="row-options-dropdown">
                <button type="button" class="portal-button portal-button-green-action portal-button-compact" data-template-edit="${template.id}">Edit</button>
                <button type="button" class="portal-button portal-button-amber-info portal-button-compact" data-template-archive="${template.id}">${archived ? "Restore" : "Archive"}</button>
                <button type="button" class="portal-button portal-button-red-action portal-button-compact" data-template-del="${template.id}">Delete</button>
              </div>
            </details>
          </td>
        `;
        ...
        filteredRows.forEach((row) => {
          ...
          <td class="table-row-options-cell">
            <details class="row-options-menu">
              <summary class="row-options-trigger portal-button portal-button-blue-action portal-button-compact">Actions</summary>
              <div class="row-options-dropdown">
                <button type="button" class="portal-button portal-button-green-action portal-button-compact" data-edit="${row.id}">Edit</button>
                <button type="button" class="portal-button portal-button-amber-info portal-button-compact" data-archive="${row.id}">${archived ? "Restore" : "Archive"}</button>
                <button type="button" class="portal-button portal-button-red-action portal-button-compact" data-del="${row.id}">Delete</button>
              </div>
            </details>
          </td>
        `;
