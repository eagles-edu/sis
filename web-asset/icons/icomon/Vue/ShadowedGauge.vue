<template>
    <svg viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" fill="none" width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs stroke-linecap="butt" stroke-linejoin="miter" fill="currentColor">
            ...
            <linearGradient id="shadowed_gauge_gradient1" gradientTransform="matrix(0.5, 0, 0, 1, 0.25, 0.1)">
                <stop offset="0%" stop-color="currentColor" stop-opacity="0" />
                <stop offset="49%" stop-color="currentColor" stop-opacity="0.6" />
                <stop offset="100%" stop-color="currentColor" stop-opacity="0" />
            </linearGradient>
        </defs>
        <g>
            ...
            <g stroke="url(#shadowed_gauge_gradient1)">
                <line stroke-width="2" stroke="currentColor" x1="12" x2="12.00005" y1="1" y2="4" />
                <path stroke-width="5" stroke="url(#shadowed_gauge_gradient2)" stroke-linecap="butt" stroke-linejoin="miter" d="M2.5001 12c0-5.2467 4.2532-9.5 9.4999-9.5s9.5 4.2533 9.5 9.5" />
            </g>
