<template>
    <svg viewBox="0 0 24 24" stroke-width="3" fill="currentColor" width="32" height="32" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs stroke-width="1">
        ...
        <g fill="none" transform-origin="12 12">
