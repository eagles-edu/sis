(() => {
  ...
  function etymologyHtml(rowUid) {
    ...
    return `<div class="vocabulary-etymology-fields" data-vocabulary-etymology-fields>
      ...
      <label class="vocabulary-pos-control">Origin path<input name="vocabularyEsl-etymology-${uid}" data-vocabulary-esl-field="etymology" placeholder="Borrowed from French; formed with ..." aria-label="Origin path"></label>
